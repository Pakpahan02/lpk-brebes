...
final class FQADataTable extends PowerGridComponent
{
    public string $tableName = 'f-q-a-data-table-rvptpb-table';
    ...
    public function fields(): PowerGridFields
    {
        return PowerGrid::fields()
            ...
            ->add('title')
            ->add('description')
            ->add('created_at_formatted', fn (FQA $model) => Carbon::parse($model->created_at)->translatedFormat('j F Y H:i'));
    }
    ...
    public function actions(FQA $row): array
    {
        $deletionRoute = route('dashboard.cms.fqa.destroy', $row->id);
        ...
        return [
            Button::add('edit')
                ...
                ->route('dashboard.cms.fqa.edit', ['fqa' => $row->id]),
